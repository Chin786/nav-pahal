...
import { Eye, Rocket, Quote, RefreshCw, Sparkles } from 'lucide-react';
          ...
          <div className="space-y-10">
            <div className="space-y-4">
              ...
              <p className="text-[#44474e] text-sm sm:text-base leading-relaxed">
                Navpahal's foundations are structured to drive transparency, rapid execution, and deep systemic improvements in grassroots community welfare.
              </p>
            </div>
            ...
            <div className="grid gap-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-2 flex-1">
                    ...
                    <p className="text-slate-600 text-sm leading-relaxed">
                      To build a world where every community has the tools, network, and expertise to drive their own sustainable evolution.
                    </p>
                    ...
                    <AnimatePresence>
                      {visionExpanded && (
                        ...
                        >
                          <p>
                            We aim to bypass traditional delays in resource distribution. Through custom tech frameworks, we enable instant verification of grassroots needs to secure immediate matching with corporate capital and expert mentoring.
                          </p>
                          <p className="font-semibold text-[#0072CE]">
                            • Decentralized growth  • Fully audit-mapped pipeline  • Inclusive action
                          </p>
                        </motion.div>
                      )}
                    </AnimatePresence>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-2 flex-1">
                    <div className="flex justify-between items-center">
                      <h4 className="text-lg font-bold text-[#031635] font-headline">Our Mission</h4>
                      <span className="text-xs font-bold text-[#72BF44] uppercase tracking-wider">
                        {missionExpanded ? 'Show Less' : 'Read Deeply'}
                      </span>
                    </div>
                    <p className="text-slate-600 text-sm leading-relaxed">
                      Systemizing social impact through innovative technology, verified medical networks, and corporate-NGO synergy.
                    </p>
                    ...
                    <AnimatePresence>
                      {missionExpanded && (
                        ...
                        >
                          <p>
                            By integrating the four pillars (Citizens, Volunteers, Doctors, Partners) under one cohesive engine, we accelerate healthcare delivery response speeds, scale direct skills development, and drive the highest levels of structural accountability.
                          </p>
                          <p className="font-semibold text-[#72BF44]">
                            • Direct execution  • Corporate responsibility synergy • Rapid health grid
                          </p>
                        </motion.div>
                      )}
                    </AnimatePresence>
