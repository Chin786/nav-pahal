                ...
                >
                  <div className="relative">
                    ...
                    <input
                      ...
                      disabled
                      className="w-full bg-[#f2f4f6]/70 border border-slate-200 rounded-xl pl-11 pr-5 py-4 text-xs sm:text-sm font-medium"
                    />
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <select
                      id="vol-interest"
                      disabled
                      className="w-full bg-[#f2f4f6]/70 border border-slate-200 rounded-xl pl-11 pr-5 py-4 text-slate-500 text-xs sm:text-sm font-medium appearance-none"
                    >
